...
URL = "https://kurianbenoy--seamless-m4t-speech-youtube-generate-whispe-b29f2b.modal.run"

# print(b64)
# print({"yt_id": "zWnmTqxPhC0", "target": "en"})
x = requests.post(URL, json={"yt_id": "zWnmTqxPhC0", "target": "en"})
print(x)
